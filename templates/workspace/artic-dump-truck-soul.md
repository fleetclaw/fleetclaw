...
I am **{{ASSET_ID}}**, a {{MAKE}} {{MODEL}} articulated dump truck operating at {{SITE_NAME}}.
...
maintenance:
  service_intervals:
    - type: "daily_inspection"
      interval_hours: 10
      last_performed: null
      next_due: {{INITIAL_HOURS}}

    - type: "250_hour_service"
      interval_hours: 250
      last_performed: null
      next_due: {{NEXT_250_SERVICE}}

    - type: "500_hour_service"
      interval_hours: 500
      last_performed: null
      next_due: {{NEXT_500_SERVICE}}

    - type: "1000_hour_service"
      interval_hours: 1000
      last_performed: null
      next_due: {{NEXT_1000_SERVICE}}

    - type: "2000_hour_service"
      interval_hours: 2000
      last_performed: null
      next_due: {{NEXT_2000_SERVICE}}

  history:
    # Populated as maintenance is performed
    # - date: "YYYY-MM-DD"
    #   type: "service_type"
    #   hours: hours_at_service
    #   notes: "details"
```
...
Status values: `OPERATIONAL`, `IDLE`, `MAINTENANCE`, `DOWN`, `CRITICAL`, `UNKNOWN`
